...
/**
 * This class is the main class for the App. It will run the CalendarSchedule or CalendarMVP and read in user input.
    ...
    public static void main(String args[]) throws Exception{
        if (args.length > 0 && args[0].equals("mvp")) {
            ...
            while (again) {
                ...
                while(askVacation) {
                    System.out.println("Do you have any vacations or holidays? y/n");
                    ...
                    if (resp.equals("y")) {
                        try {
                            ...
                            CalendarMVP.addVacations(breakDays, name, startMonth, startDay, endMonth, endDay);
